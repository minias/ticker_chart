...
class CoinbaseTickerRepository implements TickerRepository {
  @override
  Future<TickerModel> fetchTicker() async {
    return _fetchTicker(Exchange.coinbase, Config.coinbaseApiUrl);
  }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw ServerException(
          '${ErrorCodes.failedToFetchCoinbase}: ${response.statusCode}',
        );
      }
    } catch (e) {
      throw NetworkException('${ErrorCodes.failedToFetchCoinbase}: $e');
    }
  }
